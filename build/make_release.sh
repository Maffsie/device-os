...
usage: make_release.sh [--debug] [--help]
                       ...
                       |b5som|electron|p1|photon|tracker|xenon>]
...
function valid_platform()
{
    ...
    [ "$platform" = "all" ] || [ "$platform" = "argon" ] || [ "$platform" = "asom" ] || [ "$platform" = "boron" ] || [ "$platform" = "bsom" ] || [ "$platform" = "b5som" ] || [ "$platform" = "electron" ] || [ "$platform" = "p1" ] || [ "$platform" = "photon" ] || [ "$platform" = "tracker" ] || [ "$platform" = "xenon" ]
}
